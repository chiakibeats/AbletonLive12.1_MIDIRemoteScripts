...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\auto_filter.py
...
class AutoFilterDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    def _filter_visualisation_data(self):
        ...
        return {'FilterLeft': VisualisationGuides.light_left_x(0), 'FilterRight': VisualisationGuides.light_right_x(2), 'FilterFocus': filter_focus}
