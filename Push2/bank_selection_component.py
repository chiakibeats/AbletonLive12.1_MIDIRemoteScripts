...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\bank_selection_component.py
...
class BankProvider(ItemProvider):
    ...
    def internal_bank_names(self, original_bank_names):
        ...
        return original_bank_names if num_banks > 0 else [BANK_MAIN_KEY]
