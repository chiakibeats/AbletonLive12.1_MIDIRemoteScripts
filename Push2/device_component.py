...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\device_component.py
...
class DeviceComponentWithTrackColorViewData(GenericDeviceComponent):
    def _set_device(self, device):
        ...
        return device if liveobj_valid(device) else None
            ...
            self.__on_device_active_changed.subject = None
...
ENVELOPE_FEATURES_FOR_PARAMETER = {'Attack': set(['AttackLine', 'AttackNode', 'DecayLine']), 'Decay': set(['DecayLine', 'DecayNode', 'SustainLine']), 'Sustain': set(['DecayLine', 'DecayNode', 'SustainLine', 'SustainNode', 'ReleaseLine']), 'Release': set(['ReleaseLine', 'ReleaseNode']), 'Init': set(['InitNode', 'AttackLine']), 'Initial': set(['InitNode', 'AttackLine']), 'Peak': set(['AttackLine']), 'End': set(['DecayLine']), 'Final': set(['ReleaseLine']), 'A Slope': set(['AttackLine']), 'D Slope': set(['DecayLine']), 'R Slope': set(['FadeInLine', 'FadeInNode', 'SustainLine']), 'Fade In': set(['FadeOutLine'
