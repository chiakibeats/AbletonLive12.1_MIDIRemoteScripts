...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\corpus.py
...
class CorpusDeviceDecorator(LiveObjectDecorator, EventObject):
    ...
    def __init__(self, *a, **k):
        ...
        self.note_off_option = DeviceOnOffOption(name='Off Decay', property_host=get_parameter_by_name(self, 'Note Off'))
...
class CorpusDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    def _get_current_view_data(self):
        ...
        return {'FilterLeft': start_position_in_px, 'FilterRight': end_position_in_px, 'IsVisualisationVisible': self._visualisation_visible}
