...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\drum_pad_parameter_component.py
...
def get_first_chain(drum_pad):
    return drum_pad.chains[0] if liveobj_valid(drum_pad) and len(drum_pad.chains) > 0 else None
...
class ChokeParameter(InternalParameterBase):
    ...
    def value(self):
        ...
        return first_chain.choke_group if liveobj_valid(first_chain) else 0
