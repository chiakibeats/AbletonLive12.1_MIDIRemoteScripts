...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\chorus2.py
...
class Chorus2DeviceDecorator(LiveObjectDecorator, EventObject):
    ...
    def __init__(self, *a, **k):
        ...
        self.hpf_enabled_option = DeviceOnOffOption(name='High Pass', property_host=get_parameter_by_name(self, 'HPF Enabled'))
