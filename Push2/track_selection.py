...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\track_selection.py
...
def get_chains_recursive(track_or_chain):
    ...
    chains = []
    if instruments and old_hasattr(instruments[0], 'chains'):
