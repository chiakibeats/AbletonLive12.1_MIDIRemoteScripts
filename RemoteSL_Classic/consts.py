...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL_Classic\consts.py
...
TS_LOOP_CC = 77
TS_LOCK = 79
ts_ccs = [TS_REWIND_CC, TS_FORWARD_CC, TS_STOP_CC, TS_PLAY_CC, TS_RECORD_CC, TS_LOOP_CC, TS_LOCK, TS_LOCK + 1]
ts_notes = []
