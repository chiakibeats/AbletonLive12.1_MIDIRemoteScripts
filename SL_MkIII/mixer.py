...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\SL_MkIII\mixer.py
...
class MixerComponent(MixerComponentBase):
    ...
    def _update_send_value_display(self):
        for index, send in enumerate(self.controlled_sends):
            return str(send) if send else None
            else:  # inserted
                self.send_value_display[index] = ''
            continue
