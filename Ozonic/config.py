...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Ozonic\config.py
...
pass
CONTROLLER_DESCRIPTION = {'INPUTPORT': 'Ozonic (Keyboard)', 'OUTPUTPORT': 'Ozonic (Keyboard)', 'CHANNEL': 0}
pass
