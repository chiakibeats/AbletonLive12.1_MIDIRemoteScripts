...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ProjectMixIO\ProjectMixIO.py
...
class ProjectMixIO(object):
    ...
    def handle_display_switch_ids(self, switch_id, value):
        if switch_id == SID_DISPLAY_NAME_VALUE and value == BUTTON_PRESSED:
