...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\consts.py
...
PAN_X_MASTER_CC = 36
PAN_Y_MASTER_CC = 16
LAUNCH_NOTES = [0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120]
...
MASTER_EQ_CCS = [56, 76, 96, 116]
VOLUME_CCS = list(range(0, 16))
SCENE_LAUNCH_NOTES = [8, 9, 10, 11, 12, 13, 14, 15, 39, 40, 41, 42]
GLOBAL_PLAY_NOTE = 35
GLOBAL_STOP_NOTE = 36
...
MASTER_SEND_CCS = [56, 76, 96, 116]
EQ_CCS = [[x + i for x in [40, 60, 80, 100]] for i in range(0, 16)]
SLOT_LAUNCH_NOTES1 = [list(range(i * 8, i * 8 + 6)) for i in range(0, 16)]
SLOT_LAUNCH_NOTES2 = [[6, 7, 55, 56, 57, 58], [14, 15, 59, 60, 61, 62], [22, 23, 63, 64, 65, 66], [30, 31, 67, 68, 69, 70], [38, 39, 71, 72, 73, 74], [54, 55, 79, 80, 81, 82], [62, 63, 83, 84, 85, 86], [78, 79, 91, 92, 93, 94], [86, 87, 95, 96, 97, 98], [94, 95, 99, 100, 101, 102], [102, 103], [110, 111], [118, 119], [126, 127]]
STATUS_MASK = 240
CHAN_MASK = 15
CC_STATUS = 176
NOTEON_STATUS = 144
