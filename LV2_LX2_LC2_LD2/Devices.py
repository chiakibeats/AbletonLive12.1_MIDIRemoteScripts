...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\Devices.py
...
TEN_BOB = ('Exciter Type', 'Exc ForceMassProt', 'String Decay', 'Str Damping', 'Vib Amount', 'Filter Freq', 'Filter Reso', 'Volume')
TEN_BOBS = TEN_BOB
...
NTL_BANK1 = ('Trigger Source', 'Time Length', 'Synced Length', 'Gate', 'Decay Time', 'Release Velocity', 'Decay Key Scale', '')
NTL_BANKS = NTL_BANK1
NTL_BOBS = NTL_BANK1
...
CP2_BANK1_LIVE7 = ('Threshold', 'Ratio', 'Attack', 'Release', 'S/C Gain', 'S/C Mix', 'S/C EQ Freq', 'Output Gain')
...
SAT_BOB = ('Drive', 'Color Amt Low', 'Color Freq', 'Color Amt Hi', 'WS Curve', 'WS Depth', 'WS Period', 'WS Damp')
...
RVB_BOB = ('Decay Time', 'Room Size', 'Chorus Amount', 'In Filter Freq', 'HiFilter Freq', 'HiShelf Gain', 'Stereo Image', 'Dry/Wet')
...
PPG_BANKS = PPG_BANK1
PPG_BOBS = PPG_BANK1
DEVICE_DICT = {'AudioEffectGroupDevice': RCK_BANKS, 'MidiEffectGroupDevice': RCK_BANKS, 'DrumGroupDevice': RCK_BANKS, 'InstrumentGroupDevice': RCK_BANKS, 'InstrumentImpulse': IMP_BANKS, 'Operator': OPR_BANKS, 'OriginalSimpler': SIM_BANKS, 'MultiSampler': SAM_BANKS, 'MidiArpeggiator': ARP_BANKS, 'MidiChord': CRD_BANKS, 'MidiNoteLength': NTL_BANKS, 'MidiPitcher': PIT_BANKS, 'MidiRandom': RND_BANKS, 'MidiScale': EQ3_BANKS, 'Erosion': ERO_BANKS, 'Flanger': FLG_BANKS, 'GrainDelay': GRD_BANKS, 'Phaser': PHS_BANKS, 'Redux': RDX_BANKS, 'Saturator': SAT_BANKS, 'Resonator': RSN_BANKS, 'StereoGain': UTL_BANKS, 'Tube': DTB_BANKS, 'Reverb': RVB_BANKS, 'RVB_BANKS': {'Vinyl': VDS_BANKS, 'Gate': GTE_BANKS}, 'VDS_BANKS': {'Vinyl': GTE_BANKS, 'Gate': Vinyl, 'DEVICE_DICT': {'GRD_BANKS': Resonator, 'Phaser'
DEVICE_BOB_DICT = {'AudioEffectGroupDevice': RCK_BOBS, 'MidiEffectGroupDevice': RCK_BOBS, 'InstrumentGroupDevice': RCK_BOBS, 'DrumGroupDevice': RCK_BOBS, 'InstrumentImpulse': IMP_BOBS, 'Operator': OPR_BOBS, 'OriginalSimpler': SIM_BOBS, 'MultiSampler': SAM_BOBS, 'UltraAnalog': ANA_BOBS, 'StringStudio': TEN_BOBS, 'LoungeLizard': ELEC_BOBS, 'ProxyInstrumentDevice': EXTINST_BOBS, 'MidiArpeggiator': ARP_BOBS, 'MidiChord': CHR_BOBS, 'BeatRepeat': BRP_BOBS, 'Eq8': EQ8_BOBS, 'FilterEQ3': EQ3_BOBS, 'Erosion': ERO_BOBS, 'FilterDelay': FLD_BOBS, 'Flanger': FLG_BOBS, 'GrainDelay': GRD_BOBS, 'Phaser': PHS_BOBS, 'PHS_BOBS': RDX_BOBS, 'Saturator': SAT_BOBS, 'SAT_BOBS': {'ProxyAudioEffectDevice': EXTEFFECT_BOBS, 'Resonator': RSN_BOBS, 'StereoGain': UTL_BOBS, 'Reverb': RVB_BOBS, 'Vinyl': VDS_BOBS, 'Gate': TEN_BOBS}, 'GRD_BOBS': {'
BANK_NAME_DICT = {'AudioEffectGroupDevice': RCK_BNK_NAMES, 'MidiEffectGroupDevice': RCK_BNK_NAMES, 'InstrumentGroupDevice': RCK_BNK_NAMES, 'DrumGroupDevice': RCK_BNK_NAMES, 'InstrumentImpulse': IMP_BNK_NAMES, 'Operator': OPR_BNK_NAMES, 'OriginalSimpler': SIM_BNK_NAMES, 'MultiSampler': SAM_BNK_NAMES, 'MidiArpeggiator': ARP_BNK_NAMES, 'MidiChord': CRD_BNK_NAMES, 'BeatRepeat': BRP_BNK_NAMES, 'Eq8': EQ8_BNK_NAMES, 'FilterDelay': FLD_BNK_NAMES, 'Flanger': FLG_BNK_NAMES, 'Phaser': PHS_BNK_NAMES, 'Saturator': SAT_BNK_NAMES, 'Resonator': RSN_BNK_NAMES, **{'Reverb': RVB_BNK_NAMES, 'StereoGain': UTL_BANK_NAMES}}
DEVICE_DICT = {'AudioEffectGroupDevice': RCK_BANKS, 'MidiEffectGroupDevice': RCK_BANKS, 'InstrumentGroupDevice': RCK_BANKS, 'InstrumentImpulse': IMP_BANKS, 'Operator': OPR_BANKS, 'OriginalSimpler': SIM_BANKS, 'MultiSampler': SAM_BANKS, 'MidiArpeggiator': ARP_BANKS, 'MidiChord': CRD_BANKS, 'MidiNoteLength': NTL_BANKS, 'MidiPitcher': PIT_BANKS, 'MidiRandom': RND_BANKS, 'MidiScale': SCL_BANKS, 'Flanger': FLG_BANKS, 'GrainDelay': GRD_BANKS, 'Phaser': PHS_BANKS, 'Redux': RDX_BANKS, 'Saturator': SAT_BANKS, 'Resonator': RSN_BANKS, 'StereoGain': UTL_BANKS, 'Reverb': RVB_BANKS, 'Vinyl': VDS_BANKS, 'Gate': GTE_BANKS}
FIVETOSIX_DICT = {'Auto Filter': 'AutoFilter', 'Auto Pan': 'AutoPan', 'Beat Repeat': 'BeatRepeat', 'Chorus': 'Chorus', 'Compressor I': 'Compressor', 'Compressor II': 'Compressor2', 'EQ Four': 'Eq8', 'EQ Three': 'FilterEQ3', 'Erosion': 'Erosion', 'Filter Delay': 'FilterDelay', 'Flanger': 'Flanger', 'Resonators': 'Resonator', 'Reverb': 'Reverb', 'Saturator': 'Saturator', 'Utility': 'StereoGain', 'Vinyl Distortion': 'Vinyl', 'Arpeggiator': 'MidiArpeggiator', 'Chord': 'MidiChord', 'Pitch': 'MidiPitcher', 'Random': 'MidiRandom', 'Scale': 'MidiScale', 'Velocity': 'MidiVelocity', 'Simpler': 'OriginalSimpler', 'Impulse': 'InstrumentImpulse', 'Operator': 'Operator'}
INVERT_QUANT_PARAM = {'FilterDelay.1 Beat Delay': 1, 'FilterDelay.2 Beat Delay': 1, 'FilterDelay.3 Beat Delay': 1}