...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\FaderfoxScript.py
...
class FaderfoxScript(object):
    ...
    __module__ = __name__
    'Automap script for Faderfox controllers'
    __version__ = 'V1.1'
