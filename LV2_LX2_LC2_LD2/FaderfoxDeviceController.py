...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\FaderfoxDeviceController.py
    ...
    def map_device_params(self, script_handle, midi_map_handle):
        ...
        if self.device:
            ...
            if device_name in list(DEVICE_BOB_DICT.keys()):
                ...
                if device_name == 'Compressor2' and self.helper.get_parameter_by_name(self.device, 'S/C Gain'):
                ...
                self.log('Could not find %s in %s' % (device_name, list(DEVICE_BOB_DICT.keys())))
                return
