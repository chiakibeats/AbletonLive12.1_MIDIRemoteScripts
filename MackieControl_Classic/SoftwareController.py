...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControl_Classic\SoftwareController.py
...
class SoftwareController(MackieControlComponent):
    ...
    def destroy(self):
        ...
        self.song().view.remove_follow_song_listener(self.__update_follow_song_button_led)
