...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\control\control_list.py
...
class ControlList(Control):
    ...
    class State(Control.State):
        ...
        def control_count(self, count):
            ...
            if len(self._controls) != count and dynamic_create:
                pass
            if self._dynamic_create != dynamic_create:
