...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\device_navigation.py
        ...
        if selected_item is not None:
            ...
            if len(items) > self._num_visible_items:
                ...
                if selected_index >= self._num_visible_items + self.item_offset - 1 and selected_index < len(items) - 1:
                    ...
                    if selected_index > 0 and selected_index <= self.item_offset:
