...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\session_overview.py
...
class SessionOverviewComponent(Component):
    ...
    def __on_matrix_value(self, value, x, y, is_momentary):
        if self.is_enabled() and (value != 0 or not is_momentary):
