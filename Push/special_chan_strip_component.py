...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\special_chan_strip_component.py
...
class SpecialChanStripComponent(components.ChannelStripComponent, Messenger):
    ...
    def _update_parameter_values(self):
        ...
        if not self._track or self._track!= self.song.master_track:
    ...
    def _connect_parameters(self):
        ...
        if self._pan_control!= None and liveobj_valid(self._track) and is_set_to_split_stereo(self._track.mixer_device):
