...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\user_settings_component.py
...
class UserSettingsComponent(Component):
    ...
    def _update_display(self):
        ...
        def setting_property(index, display, getter):
            if 0 <= index < num_settings:
                value = getter(self._settings[index]) if not self._settings[index] else ''
            index += 1
