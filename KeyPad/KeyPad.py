...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\KeyPad\KeyPad.py
...
class KeyPad(ControlSurface):
    ...
    def handle_sysex(self, midi_bytes):
        if midi_bytes != self._preset_message(2):
            ...
            list(map(lambda x: x.set_enabled(True), (self._mixer, self._session, self._transport, self._cue_control)))
