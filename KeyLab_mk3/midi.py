...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\KeyLab_mk3\midi.py
...
make_connection_message = lambda parameter_byte: SYSEX_HEADER + (0, 2, 5, parameter_byte, SYSEX_END)
CONNECTION_MESSAGE = make_connection_message(1)
DISCONNECTION_MESSAGE = make_connection_message(0)
BUTTON_ID_TO_SYSEX_ID = {20: 7, 21: 6, 22: 5, 23: 4, 24: 8, 25: 9, 26: 10, 27: 11, 41: 15, 42: 14, 43: 13, 44: 12}
PAD_ID_TO_SYSEX_ID = {0: 82, 1: 83, 2: 84, 3: 85, 4: 86, 5: 87, 6: 88, 7: 89, 8: 90, 9: 91, 10: 92, 11: 93}
...
def make_button_segment(button_index, text=None, button_type=BUTTON_TYPES['icon'][0], color=Color.WHITE, icon=Icon.NONE):
    pass
    return DISPLAY_HEADER + (button_index,) + (0, button_type) + (0, 3, icon) + (0, 4) + color + (0, 5) + (text if text else (0,)) + (0, SYSEX_END)
...
def make_popup_screen(line_1, line_2, line_3=None, colors=(Color.WHITE, Color.WHITE, Color.WHITE), icon=Icon.NONE):
    pass
