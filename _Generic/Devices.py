...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Generic\Devices.py
...
ALG_BANKS = (ALG_BANK1, ALG_BANK2, ALG_BANK3, ALG_BANK4, ALG_BANK5, ALG_BANK6, ALG_BANK7)
ALG_BOBS = (ALG_BOB,)
...
COL_BANKS = (COL_BANK1, COL_BANK2, COL_BANK3, COL_BANK4, COL_BANK5, COL_BANK6)
COL_BOBS = (COL_BOB,)
...
ELC_BANKS = (ELC_BANK1, ELC_BANK2, ELC_BANK3, ELC_BANK4, ELC_BANK5)
ELC_BOBS = (ELC_BOB,)
...
IMP_BANKS = (IMP_BANK1, IMP_BANK2, IMP_BANK3, IMP_BANK4, IMP_BANK5, IMP_BANK6, IMP_BANK7, IMP_BANK8)
IMP_BOBS = (IMP_BOB,)
...
OPR_BANKS = (OPR_BANK1, OPR_BANK2, OPR_BANK3, OPR_BANK4, OPR_BANK5, OPR_BANK6, OPR_BANK7, OPR_BANK8)
OPR_BOBS = (OPR_BOB,)
...
SAM_BANKS = (SAM_BANK1, SAM_BANK2, SAM_BANK3, SAM_BANK4, SAM_BANK5, SAM_BANK6, SAM_BANK7, SAM_BANK8)
SAM_BOBS = (SAM_BOB,)
...
TNS_BANK1 = ('Exciter Type', 'String Decay', 'Str Inharmon', 'Str Damping', 'Exc ForceMassProt', 'Exc FricStiff', 'Exc Velocity', 'E Pos')
...
TNS_BOB = ('Filter Freq', 'Filter Reso', 'Filter Type', 'Exciter Type', 'E Pos', 'String Decay', 'Str Damping', 'Volume')
TNS_BANKS = (TNS_BANK1, TNS_BANK2, TNS_BANK3, TNS_BANK4, TNS_BANK5, TNS_BANK6, TNS_BANK7, TNS_BANK8)
TNS_BOBS = (TNS_BOB,)
TNS_BNK_NAMES = ('Exciter and String', 'Damper', 'Termination and Pickup', 'Body', 'Vibrato', 'Filter', 'Envelope and LFO', 'Global')
WVT_BANK1 = ('Osc 1 Transp', 'Osc 1 Detune', 'Osc 1 Pos', 'Osc 1 Effect 1', 'Osc 1 Effect 2', 'Osc 1 Pan', 'Osc 1 Gain', 'Osc 1 On')
WVT_BANK2 = ('Osc 2 Transp', 'Osc 2 Detune', 'Osc 2 Pos', 'Osc 2 Effect 1', 'Osc 2 Effect 2', 'Osc 2 Pan', 'Osc 2 Gain', 'Osc 2 On')
WVT_BANK3 = ('Filter 1 On', 'Filter 1 Freq', 'Filter 1 Res', 'Filter 1 Drive', 'Filter 1 Type', 'Filter 1 Slope', 'Filter 1 LP/HP', 'Filter 1 BP/NO/Morph')
WVT_BANK4 = ('Filter 2 On', 'Filter 2 Freq', 'Filter 2 Res', 'Filter 2 Drive', 'Filter 2 Type', 'Filter 2 Slope', 'Filter 2 LP/HP', 'Filter 2 BP/NO/Morph')
WVT_BANK5 = ('Amp Attack', 'Amp Decay', 'Amp Sustain', 'Amp Release', 'Amp A Slope', 'Amp D Slope', 'Amp R Slope', 'Amp Loop Mode')
WVT_BANK6 = ('Env 2 Attack', 'Env 2 Decay', 'Env 2 Sustain', 'Env 2 Release', 'Env 3 Attack', 'Env 3 Decay', 'Env 3 Sustain', 'Env 3 Release')
WVT_BANK7 = ('LFO 1 Amount', 'LFO 1 Rate', 'LFO 1 S. Rate', 'LFO 1 Sync', 'LFO 2 Amount', 'LFO 2 Rate', 'LFO 2 S. Rate', 'LFO 2 Sync')
WVT_BANK8 = ('Time', 'Global Mod Amount', 'Unison Amount', 'Transpose', 'Glide', 'Sub Gain', 'Sub Transpose', 'Volume')
WVT_BOB = ('Osc 1 Pos', 'Osc 1 Transp', 'Osc 2 Pos', 'Osc 2 Transp', 'Filter 1 Freq', 'Filter 1 Res', 'Global Mod Amount', 'Volume')
WVT_BANKS = (WVT_BANK1, WVT_BANK2, WVT_BANK3, WVT_BANK4, WVT_BANK5, WVT_BANK6, WVT_BANK7, WVT_BANK8)
WVT_BOBS = (WVT_BOB,)
WVT_BANK_NAMES = ('Oscillator 1', 'Oscillator 2', 'Filter 1', 'Filter 2', 'Amp Envelope', 'Envelope 2/3', 'LFO 1/2', 'Global')
...
NTL_BANK1 = ('Sync On', 'Time Length', 'Synced Length', 'Gate', 'Release Velocity', 'Decay Time', 'Decay Key Scale', 'Latch')
NTL_BANKS = (NTL_BANK1,)
NTL_BOBS = (NTL_BANK1,)
...
CP3_BANK2 = ('Threshold', 'Expansion Ratio', 'LookAhead', 'S/C Listen', 'S/C Gain', 'Makeup', 'Dry/Wet', 'Output Gain')
CP3_BANK3 = ('S/C EQ On', 'S/C EQ Type', 'S/C EQ Freq', 'S/C EQ Q', 'S/C EQ Gain', 'S/C On', 'S/C Mix', 'S/C Gain')
...
DRB_BANK1 = ('Drive', 'Drive Type', 'Transients', 'Crunch', 'Boom Freq', 'Boom Amt', 'Boom Decay', 'Boom Audition')
DRB_BANK2 = ('Trim', 'Output Gain', 'Dry/Wet', 'Compressor On', 'Damping Freq', '', '', '')
DRB_BOB = ('Drive', 'Drive Type', 'Crunch', 'Boom Amt', 'Trim', 'Damping Freq', 'Output Gain', 'Dry/Wet')
...
DTB_BANKS = (DTB_BANK1,)
DTB_BOBS = (DTB_BANK1,)
ECH_BANK1 = ('L Division', 'R Division', 'L Sync Mode', 'R Sync Mode', 'L 16th', 'R 16th', 'L Sync', 'R Sync')
ECH_BANK2 = ('L Time', 'R Time', 'L Offset', 'R Offset', 'Link', 'Channel Mode', '', '')
ECH_BANK3 = ('Gate On', 'Gate Thr', 'Gate Release', 'Duck On', 'Duck Thr', 'Duck Release', 'Env Mix', '')
ECH_BANK4 = ('Noise On', 'Noise Amt', 'Noise Mrph', 'Wobble On', 'Wobble Amt', 'Wobble Mrph', 'Repitch', '')
...
ECH_BANK8 = ('Mod Wave', 'Mod Sync', 'Mod Rate', 'Mod Freq', 'Mod Phase', 'Dly < Mod', 'Flt < Mod', 'Mod 4x')
ECH_BOB = ('L Division', 'R Division', 'L Time', 'R Time', 'Input Gain', 'Feedback', 'Stereo Width', 'Dry Wet')
ECH_BANKS = (ECH_BANK1, ECH_BANK2, ECH_BANK3, ECH_BANK4, ECH_BANK5, ECH_BANK6, ECH_BANK7, ECH_BANK8)
ECH_BOBS = (ECH_BOB,)
ECH_BANK_NAMES = ('Sync', 'Time', 'Gate/Ducking', 'Noise/Wobble', 'Gain', 'Filter', 'Reverb', 'Modulation')
...
EQ8_BANKS = (EQ8_BANK1, EQ8_BANK2, EQ8_BANK3, EQ8_BANK4, EQ8_BANK5, EQ8_BANK6, EQ8_BANK7)
EQ8_BOBS = (EQ8_BOB,)
...
GTE_BANK2 = ('S/C EQ On', 'S/C EQ Type', 'S/C EQ Freq', 'S/C EQ Q', 'S/C EQ Gain', 'S/C On', 'S/C Mix', 'S/C Gain')
...
GLU_BANK2 = ('S/C EQ On', 'S/C EQ Type', 'S/C EQ Freq', 'S/C EQ Q', 'S/C EQ Gain', 'S/C On', 'S/C Mix', 'S/C Gain')
...
MBD_BANKS = (MBD_BANK1, MBD_BANK2, MBD_BANK3, MBD_BANK4, MBD_BANK5, MBD_BANK6)
MBD_BOBS = (MBD_BOB,)
...
RVB_BANK1 = ('In Filter Freq', 'In Filter Width', 'Predelay', 'ER Spin On', 'ER Spin Rate', 'ER Spin Amount', 'ER Shape', 'Decay Time')
RVB_BANK2 = ('HiFilter Freq', 'LowShelf Freq', 'Chorus Rate', 'Diffusion', 'HiShelf Gain', 'LowShelf Gain', 'Chorus Amount', 'Scale')
RVB_BANK3 = ('Decay Time', 'Freeze On', 'Room Size', 'Stereo Image', 'Reflect Level', 'Diffuse Level', 'Dry/Wet', 'Density')
RVB_BOB = ('Decay Time', 'Room Size', 'Predelay', 'In Filter Freq', 'Reflect Level', 'Diffuse Level', 'Stereo Image', 'Dry/Wet')
RVB_BANKS = (RVB_BANK1, RVB_BANK2, RVB_BANK3)
RVB_BOBS = (RVB_BOB,)
RVB_BNK_NAMES = ('Reflections', 'Diffusion Network', 'Global')
SAT_BANK1 = ('Drive', 'Color Amt Low', 'Color Freq', 'Color Width', 'Color Amt Hi', 'Output', 'Dry/Wet', 'Type')
SAT_BANK2 = ('WS Drive', 'WS Linearity', 'WS Curve', 'WS Damp', 'WS Depth', 'WS Period', 'Dry/Wet', '')
SAT_BOB = ('Drive', 'Type', 'Color Amt Low', 'Color Freq', 'Color Width', 'Color Amt Hi', 'Output', 'Dry/Wet')
...
SMD_BANKS = (SMD_BANK1,)
SMD_BOBS = (SMD_BANK1,)
UTL_BANK1 = ('Left Inv', 'Right Inv', 'Channel Mode', 'Stereo Width', 'Mono', 'Balance', 'Gain', 'Mute')
...
RCK_BANKS = {'AudioEffectGroupDevice': RCK_BANKS, 'MidiEffectGroupDevice': RCK_BANKS, 'InstrumentGroupDevice': RCK_BANKS, 'DrumGroupDevice': RCK_BANKS, 'InstrumentImpulse': IMP_BANKS, 'Operator': OPR_BANKS, 'UltraAnalog': ALG_BANKS, 'OriginalSimpler': SIM_BANKS, 'MultiSampler': SAM_BANKS, 'MidiArpeggiator': ARP_BANKS, 'BeatRepeat': CHR_BANKS, 'Corpus': CRP_BANKS, 'Eq8': Eq8, 'EQ8_BANKS': FilterEQ3, 'EQ3_BANKS': Erosion, 'ERO_BANKS': FilterDelay, 'FLD_BANKS': Flanger, 'FLG_BANKS': FrequencyShifter, 'FRS_BANKS': GrainDelay, 'GRD_BANKS': GRD_BANKS, 'Looper': Looper, 'LPR_BANKS': MultibandDynamics, 'MBD_BANKS': MBD_BANKS, 'Overdrive': MBD_BANKS, 'OVR_BANKS': OVR_BANKS, 'Phaser': PHS_BANKS, 'Redux': Redux, 'RDX_BANKS': RDX_BANKS, 'Saturator': SAT_BANKS, 'Resonator': RSN_BANKS, 'StereoGain': UTL_BANKS, '
RCK_BOBS = {'AudioEffectGroupDevice': RCK_BOBS, 'MidiEffectGroupDevice': RCK_BOBS, 'InstrumentGroupDevice': RCK_BOBS, 'DrumGroupDevice': RCK_BOBS, 'InstrumentImpulse': IMP_BOBS, 'Operator': OPR_BOBS, 'UltraAnalog': ALG_BOBS, 'OriginalSimpler': SIM_BOBS, 'MultiSampler': SAM_BOBS, 'MidiArpeggiator': ARP_BOBS, 'BeatRepeat': CHR_BOBS, 'Corpus': CRP_BOBS, 'Eq8': Eq8, 'EQ8_BOBS': FilterEQ3, 'EQ3_BOBS': Erosion, 'ERO_BOBS': FilterDelay, 'FLD_BOBS': Flanger, 'FLG_BOBS': FrequencyShifter, 'FRS_BOBS': GrainDelay, 'GRD_BOBS': GRD_BOBS, 'Looper': Looper, 'LPR_BOBS': MultibandDynamics, 'MBD_BOBS': MBD_BOBS, 'Overdrive': MBD_BOBS, 'OVR_BOBS': OVR_BOBS, 'Phaser': PHS_BOBS, 'Redux': Redux, 'RDX_BOBS': RDX_BOBS, 'Saturator': SAT_BOBS, 'Resonator': RSN_BOBS, 'StereoGain': UTL_BOBS, '
BANK_NAME_DICT = {'AudioEffectGroupDevice': RCK_BNK_NAMES, 'MidiEffectGroupDevice': RCK_BNK_NAMES, 'InstrumentGroupDevice': RCK_BNK_NAMES, 'DrumGroupDevice': RCK_BNK_NAMES, 'InstrumentImpulse': IMP_BNK_NAMES, 'Operator': OPR_BNK_NAMES, 'UltraAnalog': ALG_BNK_NAMES, 'OriginalSimpler': SIM_BNK_NAMES, 'MultiSampler': SAM_BNK_NAMES, 'MidiArpeggiator': ARP_BNK_NAMES, 'LoungeLizard': ELC_BNK_NAMES, 'StringStudio': TNS_BNK_NAMES, 'Collision': COL_BNK_NAMES, 'MidiChord': PHS_BNK_NAMES, 'MultibandDynamics': MBD_BNK_NAMES, 'Reverb': RVB_BNK_NAMES, 'Vocoder': VOC_BNK_NAMES, 'Amp': AMP_BNK_NAMES, 'GlueCompressor': GLU_BNK_NAMES, 'AutoFilter': AFL_BNK_NAMES, 'StereoGain': UTL_BNK_NAMES, 'DrumBuss': DRB_BANK_NAMES, 'Echo': ECH_BANK_NAMES, 'Pedal': PDL_BANK_NAMES, 'InstrumentVector': WVT_BANK_NAMES, 'BANK_NAME_DICT': Macro 7, 'Macro 8': Macro 9, 'Macro 10': Macro 11, 'Macro 12': Macro 13, 'Macro 14': Macro 15, 'Macro 16': Macros, 'Macros 2': OSC1 Level,
