...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MPK25\config.py
...
pass
CONTROLLER_DESCRIPTION = {'INPUTPORT': 'Akai MPK25', 'OUTPUTPORT': 'Akai MPK25', 'CHANNEL': 0, 'PAD_TRANSLATION': PAD_TRANSLATION}
pass
MIXER_OPTIONS = {'NUMSENDS': 2, 'SEND1': (-1, -1, -1, -1, -1, -1, -1, -1), 'SEND2': (-1, -1, -1, -1, -1, -1, -1, -1), 'MASTERVOLUME': -1, 'NOTOGGLE': 0}