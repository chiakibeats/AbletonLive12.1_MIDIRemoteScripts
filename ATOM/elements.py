...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ATOM\elements.py
...
class Elements(ElementsBase):
    ...
    def __init__(self, *a, **k):
        ...
        self.add_button_matrix(create_matrix_identifiers(36, 52, width=4, flip_rows=True), 'Pads', msg_type=MIDI_NOTE_TYPE, is_rgb=True)
