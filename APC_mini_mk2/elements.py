...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\APC_mini_mk2\elements.py
...
class Elements(ElementsBase):
    ...
    def __init__(self, *a, **k):
        ...
        self.add_button_matrix(create_matrix_identifiers(0, 64, width=8, flip_rows=True), 'Clip_Launch_Buttons', msg_type=MIDI_NOTE_TYPE, led_channel=FULL_BRIGHTNESS_CHANNEL)
        self.add_button_matrix(create_matrix_identifiers(64, 128, width=8, flip_rows=True), 'Drum_Pads', msg_type=MIDI_NOTE_TYPE, channels=9)
        ...
        self.add_sysex_element(PAD_MODE_HEADER, 'Pad_Mode_Control', lambda v: PAD_MODE_HEADER + (v, SYSEX_END), use_first_byte_as_value=True)