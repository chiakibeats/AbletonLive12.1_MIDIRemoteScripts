...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_25_49_61\consts.py
...
ETCHINGS = ['track', 'inst_fx', 'memory', 'parameter', 'value', 'pan', 'l', 'r', 'program', 'volume', 'edit', 'channel', 'strip', 'hyper', 'page', 'send', 'bank', 'pad', 'knob', 'fader', 'button']
LED_OFF = 0
GRN_LOW = 1
RED_LOW = 2
AMB_LOW = 3
