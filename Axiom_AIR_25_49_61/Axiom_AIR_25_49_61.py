...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_25_49_61\Axiom_AIR_25_49_61.py
...
class Axiom_AIR_25_49_61(ControlSurface):
    ...
    def _identify_value(self, value):
        ...
        if value > 0:
            ...
            self._identify_button.turn_off()
