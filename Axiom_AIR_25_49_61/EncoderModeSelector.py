...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_25_49_61\EncoderModeSelector.py
...
class EncoderModeSelector(ModeSelectorComponent):
    ...
    def _mode_value(self, value, sender):
        if not (self.is_enabled() and value != 0):
            pass
        if not sender.is_momentary():
