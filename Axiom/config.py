...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom\config.py
...
pass
DEVICE_CONTROLS = (GENERIC_ENC5, GENERIC_ENC6, GENERIC_ENC7, GENERIC_ENC8, GENERIC_ENC1, GENERIC_ENC2, GENERIC_ENC3, GENERIC_ENC4)
pass
...
pass
CONTROLLER_DESCRIPTION = {'INPUTPORT': 'USB Axiom', 'OUTPUTPORT': 'USB Axiom', 'CHANNEL': 0, 'PAD_TRANSLATION': PAD_TRANSLATION}
pass
MIXER_OPTIONS = {'NUMSENDS': 2, 'SEND1': (-1, -1, -1, -1, -1, -1, -1, -1), 'SEND2': (-1, -1, -1, -1, -1, -1, -1, -1), 'MASTERVOLUME': GENERIC_SLI9}