...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Arturia\ArturiaControlSurface.py
...
BUTTON_MSG_TYPES = {'note': BUTTON_NOTE_MODE, 'cc': BUTTON_CC_MODE}
SETUP_HARDWARE_DELAY = 1.0
INDIVIDUAL_MESSAGE_DELAY = 0.001
LIVE_MODE_MSG_HEAD = SETUP_MSG_PREFIX + (WRITE_COMMAND, WORKING_MEMORY_ID, LIVE_MODE_PROPERTY, LIVE_MODE_MSG_HARDWARE_ID_BYTE)
