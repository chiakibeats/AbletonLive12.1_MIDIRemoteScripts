...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_DirectLink\Axiom_DirectLink.py
...
PAD_TRANSLATIONS = ((0, 3, 60, 15), (1, 3, 62, 15), (2, 3, 64, 15), (3, 3, 65, 15), (0, 2, 67, 15), (1, 2, 69, 15), (2, 2, 71, 15), (3, 2, 72, 15))
...
class Axiom_DirectLink(ControlSurface):
    ...
    def _device_bank_value(self, value):
        if not self._device_component.is_enabled() or value > 0:
