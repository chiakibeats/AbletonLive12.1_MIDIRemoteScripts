...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControlXT\MackieControlXT.py
...
class MackieControlXT(object):
    ...
    def request_firmware_version(self):
        if not self._received_firmware_version:
            self.send_midi((240, 0, 0, 102, SYSEX_DEVICE_TYPE_XT, 19, 0, 247))
    ...
    def receive_midi(self, midi_bytes):
        ...
        elif midi_bytes[0] == 240 and len(midi_bytes) == 12:
            if midi_bytes[5] == 20:
