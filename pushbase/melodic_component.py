...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\melodic_component.py
    ...
    def _show_notes_information(self, mode=None):
        if self.is_enabled() and self.show_notifications:
                ...
                if mode == 'sequence':
                    ...
                    self.show_notification(message % (index_to_name_func(start_note), index_to_name_func(end_note)))
                    return
                else:  # inserted
