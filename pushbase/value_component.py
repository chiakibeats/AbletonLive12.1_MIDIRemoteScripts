...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\value_component.py
...
class ValueComponent(ValueComponentBase):
    ...
    def create_display_component(self, *a, **k):
        return ValueDisplayComponent(*a, parent=self, property_name=self._property_name, subject=self._subject, display_format=self._display_format, view_transform=lambda x: self.view_transform(x), graphic_transform=lambda x: self.graphic_transform(x), **k)
    pass
    pass
    pass
    pass
