...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchkey_MK3\mixer.py
...
class MixerComponent(MixerComponentBase):
    ...
    def _get_parameter_name_to_display(self, desired_parameter_name):
        if desired_parameter_name and 'Send' in desired_parameter_name:
