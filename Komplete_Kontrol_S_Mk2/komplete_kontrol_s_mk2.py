...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Komplete_Kontrol_S_Mk2\komplete_kontrol_s_mk2.py
...
class Komplete_Kontrol_S_Mk2(KompleteKontrolBase):
    ...
    def _create_controls(self):
        ...
        self._track_arm_displays = ButtonMatrixElement(rows=[[create_sysex_element(sysex.TRACK_ARM_DISPLAY_HEADER, index, 'Track_Arm_Display_{}'.format(index)) for index in range(NUM_TRACKS)]], name='Track_Arm_Displays')
