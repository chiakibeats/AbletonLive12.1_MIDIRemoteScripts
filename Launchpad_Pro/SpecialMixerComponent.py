...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\SpecialMixerComponent.py
...
SEND_COLORS = (('Sends.A', 'Sends.AAvail'), ('Sends.B', 'Sends.BAvail'), ('Sends.C', 'Sends.CAvail'), ('Sends.D', 'Sends.DAvail'), ('Sends.E', 'Sends.EAvail'), ('Sends.F', 'Sends.FAvail'), ('Sends.G', 'Sends.GAvail'), ('Sends.H', 'Sends.HAvail'))
    ...
    def set_send_controls(self, controls):
        ...
        for strip, control in zip_longest(self._channel_strips, controls or []):
            if self.send_index is not None:
                pass  # postinserted
            if self.send_index not in range(8):
