...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\EncoderElement.py
...
ENCODER_VALUE_NORMALIZER = {_map_modes.relative_smooth_two_compliment: lambda v: v if v <= 64 else v - 128, _map_modes.relative_smooth_signed_bit: lambda v: v if v <= 64 else 64 - v, _map_modes.relative_smooth_binary_offset: lambda v: v - 64}
MAX_14_BIT_CC = 95
