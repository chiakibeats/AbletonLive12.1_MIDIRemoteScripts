...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\SubjectSlot.py
...
class Subject(Disconnectable, metaclass=SubjectMeta):
    pass  # postinserted
