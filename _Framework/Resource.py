...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\Resource.py
...
class StackingResource(Resource):
    ...
    def _add_client(self, client, priority):
        idx = index_if(lambda __p: __p[1] > priority, self._clients)
