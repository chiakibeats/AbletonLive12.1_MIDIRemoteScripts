...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Akai_Force_MPC\session.py
...
class SessionComponent(SessionComponentBase):
    ...
    def _can_have_playing_slots(self, track):
        return liveobj_valid(track) and (not (track == self.song.master_track or track in self.song.return_tracks or self.song.master_track))