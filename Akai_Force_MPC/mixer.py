...
# Internal filename: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Akai_Force_MPC\mixer.py
...
class MixerComponent(MixerComponentBase):
    ...
    def __getattr__(self, name):
        if name.startswith('set_') and name.endswith('s'):
